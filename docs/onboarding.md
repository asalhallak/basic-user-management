...
| Goal | Read next |
|------|-----------|
| API or services | [api-jwt-authentication.md](api-jwt-authentication.md), [api-request-flow.md](api-request-flow.md), [repository-pattern.md](repository-pattern.md), [api-responses.md](api-responses.md), [api-errors.md](api-errors.md) |
