...
| Goal | Read next |
|------|-----------|
| API or services | [api-request-flow.md](api-request-flow.md), [repository-pattern.md](repository-pattern.md), [api-responses.md](api-responses.md), [api-errors.md](api-errors.md) |
| Angular / JWT | [front-end-auth.md](front-end-auth.md), [front-end-models.md](front-end-models.md), [README — Front-end and API integration](../README.md#front-end-and-api-integration) |
