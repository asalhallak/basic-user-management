...
| Angular / JWT | [front-end-auth.md](front-end-auth.md), [angular-routing.md](angular-routing.md), [api-jwt-authentication.md](api-jwt-authentication.md), [front-end-models.md](front-end-models.md), [README — Front-end and API integration](../README.md#front-end-and-api-integration) |
