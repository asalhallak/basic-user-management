...
| Tests | Karma/Jasmine configured; `extractHttpErrorMessage`, `AuthService.Login`, `AccountService.login`, and `AccountService.update` unit tests added | Add API integration tests or Angular `AccountService.getById` tests |
