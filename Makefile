...
test-api: ## Run .NET unit tests (AuthService login)
	cd UserManagementAPI && dotnet test --verbosity normal

test-frontend: ## Run Angular unit tests once (JwtInterceptor, AlertService, AuthGuard, AccountService CRUD; ChromeHeadless; matches CI)
